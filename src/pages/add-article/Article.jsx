  ...
  const handelPostNews = async (e) => {
    ...
    if (photo instanceof File) {
      try {
        ...
        const newsInfo = { title, description, photo: imageUrl, publisherName: selectedPublisher.name, publisherPhoto: selectedPublisher.photo, tags};
          ...
          <div className="relative inline-block text-left w-full">
            ...
            >
              {selectedPublisher ? (
                ...
                <>
                  <h1 className="flex justify-center mx-auto">Select Publisher</h1>
                  <svg
